...
Решить данные проблемы можно с помощью подхода __**«сначала офлайн»**__, когда приложение создается для работы даже без подключения к сети, тем самым предоставляя пользователям возможность синхронизировать свои данные, получать обновления и многое другое. 
...
Все эти факторы оказывают сильное влияние на формирование положительного отношения пользователя к приложению, что может служить конкурентным преимуществом.

### <a name="task2"></a> 2. Почему так мало offline first приложений?

Однако на данный момент далеко не все приложения поддерживают парадигму **Offline First** и вернее даже сказать, что приложение такого типа очень слабо представлены на рынке.

И, конечно, основная причина такой нераспространенности - сложность в согласованности данных.
Конечно, если приложение полностью локальное, то проблем с согласованностью нет, но в ситуации, когда доступ к приложению возможен с разных устройств мы непременно сталкиваемся со сложностью синхронизации
...
- Событийная согласованность (Eventual Consistency), которая допускает различие состояний на устройствах

Событийная согласованность признает факт наличия различных временных линий, распределенности системы и в отличие от строгой согласованности не борется с этим.

> **Главный вопрос событийной согласованности**
> 
...
Каждые из этих часов основаны на том, что синхронизировать все узлы полностью невозможно, и поэтому на множестве событий вводится отношение частичного порядка.
...
- В отличие от векторных часов их вес не зависит от количества узлов
